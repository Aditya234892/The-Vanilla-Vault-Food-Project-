                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                    {cartItems.length ? (
                        cartItems.map((item, index) => (
                            <div key={index} className="rounded-lg shadow-lg p-4" style={{ backgroundColor: "#F1E4D3" }}>
                                <div
                        ...
                        <div className='col-span-5 mt-5'>
                            <p className="text-center text-5xl font-bold" style={{ fontFamily: "Dancing Script" }}>Your cart is empty.</p>
                        </div>
                    )}
                </div>
            ...
            {isLoggedIn ? (
                ...
                <>
                    ...
                    <div className="w-full h-48 mb-4">
                        <video loop autoPlay muted className="w-full h-full object-cover rounded-md">
                    ...
                    <form className="space-y-4">
                        <div className="flex space-x-2">
                            ...
                            <input type="text" placeholder="Address" className="w-1/2 p-2 border rounded" />
                        </div>
                        ...
                        <input type="text" placeholder="Landmark (Optional)" className="w-full p-2 border rounded" />
