...
const Home = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="flex justify-between mt-4 p-4 rounded-lg bg-gradient-to-br from-teal-500 to-teal-700"
        
      >
        <div
          className="w-fit bg-cover bg-center animate__animated animate__bounceInLeft rounded-xl"
          style={{
            backgroundImage: `url(${logo1})`,
            width: "40%",
          }}
        />
        <div className="p-4 w-56 text-xl flex justify-center items-center">
          <h1
            style={{fontFamily: "Dancing Script" }}
            className="text-5xl animate__animated animate__tada text-amber-200"
          >
            Savor,
            <br />
            <br /> Relish,
        ...
        <video
          ...
          autoPlay
          muted
          className="rounded-lg shadow-lg animate__animated animate__bounceInRight"
      ...
      <div className="mt-4 flex flex-col p-4">
        ...
        <input
          ...
          value={search}
          id="searchInput"
          className="h-8 px-3 text-lg font-semibold rounded-md"
